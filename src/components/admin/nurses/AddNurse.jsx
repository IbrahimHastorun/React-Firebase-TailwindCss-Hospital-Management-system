...
const AddNurse = () => {
    ...
    return (
        <div className="mx-[20%] p-3 bg-purple-300 rounded-lg shadow-xl">
            <h2 className="text-2xl pl-3 font-bold pb-1 border-b-4 border-gray-500">Add Nurse</h2>
            <form onSubmit={submitHandle} className="py-5 pl-3 flex flex-col gap-y-5">
                <div className="flex flex-col gap-y-2">
                    <label className="text-lg font-medium pl-1" htmlFor="nurse">Nurse Name Surname <span className="text-red-500">*</span></label>
                    <input onChange={(e) => { setDisplayName(e.target.value); }} value={displayName} type="text" id="nurse" className="p-2 bg-white text-gray-500 w-full outline-none rounded text-xl" placeholder="Nurse Name Surname" />
                </div>

                <div className="flex flex-col gap-y-2">
                    <label className="text-lg font-medium pl-1">Department <span className="text-red-500">*</span></label>
                    <select onChange={(e) => { setDepartment(e.target.value); }} className="p-2 bg-white text-gray-500 w-full outline-none rounded text-xl">
                ...
                {!pending && <button className="text-white font-semibold bg-purple-700 p-2 w-1/4 transition-all rounded hover:bg-purple-500">Add Nurse</button>}
