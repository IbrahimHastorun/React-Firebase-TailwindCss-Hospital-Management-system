...
const Nurses = () => {
    const { pending , documents } = useCollection("users" , ["role" , "==" , "nurse"]);
    let order = 0;
    ...
    return (
        <table className="w-full">
            ...
            <tbody>
                ...
                {documents && documents.length === 0 && <tr><td colSpan="5" className="text-center p-3 bg-white text-2xl shadow-lg">No Nurse to Show</td></tr>}
